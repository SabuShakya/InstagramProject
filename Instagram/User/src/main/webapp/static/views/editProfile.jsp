...
<%--<div class="modal-body" id="modal-body">--%>
    ...
    <%--&lt;%&ndash;<img src="data:image/jpeg;base64,{{editProfile.profilePic.base64}}" width ="50%" height="50%">&ndash;%&gt;--%>
<%--</div>--%>

<%--<div class="modal-footer">--%>
    <%--<button class="btn btn-primary" type="button" ng-click="editProfile.uploadProfilePhoto()">Edit profile</button>--%>
