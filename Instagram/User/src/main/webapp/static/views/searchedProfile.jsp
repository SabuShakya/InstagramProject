...
<div class="main">
    ...
    <div class="stats-container">
        <div class="stat">
            <div class="number">
                <button type="button" class="btn btn-link" ng-click="searched.followersList()" ng-disabled="searched.showFollowersList">
                    {{searched.followers}}
                </button>
            </div>
        ...
        <div class="stat">
            <div class="number">
                <button type="button" class="btn btn-link" ng-click="searched.followingList()" ng-disabled="searched.showFollowingList">
                    {{searched.following}}
                </button>
            </div>
