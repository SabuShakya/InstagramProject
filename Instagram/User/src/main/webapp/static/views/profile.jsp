...
<%--<button type="button" class="btn btn-success btn-lg pull-right" ng-click="profile.openModal()" > Upload Photo</button>--%>
<%--<button type="button" class="btn btn-danger btn-lg pull-right" ng-click="profile.logout()">Logout</button>--%>

<%--<div class="container">--%>
<header>
    <button type="button" class="btn btn-success btn-lg pull-right" ng-click="profile.openModal()"> Upload Photo
    </button>
    <button type="button" class="btn btn-danger btn-lg pull-right" ng-click="profile.logout()">Logout</button>
