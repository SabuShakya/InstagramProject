...
////    }
//
//        public static List<UserPostDto> convertUserPhotosToUserPostDto(List<UserPhotodto> userPhotosList,int totalItems) {
//            List<UserPostDto> userPostDtoList = new ArrayList<UserPostDto>();
...
//
//            List<Likesdto> likesdtoList=LikesUtil.convertLikesToLikesDto(userPhotos.getLikes());
//            for (Likesdto likesdto:likesdtoList){
//                if(likesdto.getActivationStatus().equals("activated")) {
//                    countofLikes = countofLikes+1;
//                }
//            }
